...
//
//     final finishedBookingDetail = finishedBookingDetailFromJson(jsonString);

import 'dart:convert';

FinishedBookingDetail finishedBookingDetailFromJson(String str) => FinishedBookingDetail.fromJson(json.decode(str));

String finishedBookingDetailToJson(FinishedBookingDetail data) => json.encode(data.toJson());

class FinishedBookingDetail {
  FinishedBookingDetail({
    this.code,
    this.status,
    this.data,
  });
  ...
  factory FinishedBookingDetail.fromJson(Map<String, dynamic> json) => FinishedBookingDetail(
