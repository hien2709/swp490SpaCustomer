              ...
              children: [
                ...
                Container(
                  child: _loadingSlot
                    ...
                    onPressed: (int index) {
                      print(
                          "Package id ${widget.package
                              .id}--${requestDate}--${_availableTime
                              .data[index]}");
                      setState(() {
                  ...
                  child: SpinKitWave(
                    ...
                    : Container(
                    child: Text(
                      "Đã hết lịch trong ngày hôm nay hoặc không có nhân viên rảnh,xin vui lòng đặt lịch vào ngày khác.",
